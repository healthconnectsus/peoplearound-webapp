// ⚠️ SUPERSEDED — DO NOT RUN WITHOUT ASKING.
//
// As of logo v7 (2026-09-03) the brand mark is hand-designed in Photopea (the
// PA heart monogram + stacked "people / around" lockup) and lives in
// public/logo*.svg and src/app/icon.svg. Those files are NOT generated by this
// script any more. Running it would overwrite them with the old generated
// Quicksand wordmark. Kept only for history and for the re-weighting helpers.
//
