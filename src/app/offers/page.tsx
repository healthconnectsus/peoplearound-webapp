              ...
              <ul className="flex flex-col gap-2">
                {taken.map((o) => {
                  ...
                  return (
                    <li
                      key={o.id}
                      className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-black/5 bg-white px-4 py-3 text-sm opacity-75 shadow-sm dark:border-white/5 dark:bg-zinc-900"
                    >
                      <span>
