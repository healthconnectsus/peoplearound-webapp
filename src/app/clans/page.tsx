...
async function ClansPage({searchParams}:{searchParams:Promise<{clan?:string;error?:string;message?:string}>}) {
  ...
  return <><main className="w-full max-w-3xl flex-1 p-4 lg:py-6 lg:pl-36 lg:pr-8"><h1 className="text-3xl font-bold">Your clans</h1><p className="mt-2 text-sm">Your own circle of people to invite and build with. Clan membership does not change your home community or grant access to private projects.</p>
 ...
 */
export default function Page(props: Parameters<typeof ClansPage>[0]) {
  return (
    <AppShell>
