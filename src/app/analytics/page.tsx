...
function Stat({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-zinc-900">
    ...
    <AppShell>
      <main className="w-full max-w-4xl flex-1 p-4 lg:py-6 lg:pl-36 lg:pr-8">
        ...
        <section className="mt-8">
          ...
          <ul className="flex flex-col gap-2 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-zinc-900">
            <FunnelBar
              label="👁 Viewed"
              value={totalViews}
              max={totalViews}
                ...
                >
                  {days.map((d) => (
                    <span
                      ...
                      className="flex-1 rounded-t bg-emerald-500/80 transition-colors hover:bg-emerald-600"
                      style={{
        ...
        <section className="mt-8">
          ...
          {rows.length === 0 ? (
            ...
            <div className="overflow-x-auto rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-zinc-900">
              <table className="w-full min-w-[36rem] text-sm">
                <thead>
                  <tr className="border-b border-slate-200 text-left text-xs uppercase tracking-wide text-black/45 dark:border-slate-700 dark:text-white/45">
