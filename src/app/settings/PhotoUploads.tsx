  ...
  return (
    <div className="relative -mt-10 inline-block">
      ...
      <button
        ...
        className="absolute -bottom-1 -right-1 flex h-9 w-9 items-center justify-center rounded-full border border-black/10 bg-white text-black/70 shadow-sm transition-colors hover:bg-stone-100 disabled:opacity-60 dark:border-white/10 dark:bg-zinc-800 dark:text-white/70 dark:hover:bg-zinc-700"
      >
