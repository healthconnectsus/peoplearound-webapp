      ...
      <main className="w-full max-w-xl flex-1 p-4 lg:py-6 lg:pl-36 lg:pr-8">
        <div className="mb-4 flex items-center gap-3">
          <Link
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-400 transition-colors hover:bg-black/5 dark:border-slate-500 dark:hover:bg-white/10"
          >
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-sm dark:border-slate-600 dark:bg-zinc-900">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="mt-6 border-t border-slate-300 pt-5 dark:border-slate-500">
