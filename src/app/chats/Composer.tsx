  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="flex-1 rounded-full border border-black/10 bg-stone-50 px-4 py-2 text-sm outline-none transition-colors focus:border-emerald-600 dark:border-white/15 dark:bg-zinc-800"
      />
      <button
        type="submit"
        aria-label="Send"
