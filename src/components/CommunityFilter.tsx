...
export function CommunityFilter({
  ...
  return (
    <select
      ...
      className="max-w-56 cursor-pointer truncate rounded-full border border-black/10 bg-white px-2.5 py-1 text-xs font-medium normal-case tracking-normal text-emerald-700 outline-none transition-colors hover:bg-black/5 dark:border-white/15 dark:bg-zinc-900 dark:text-emerald-400 dark:hover:bg-white/10"
    >
