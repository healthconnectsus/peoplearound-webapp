  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <button
        ...
        className={
          on
            ? "rounded-full border border-black/15 px-5 py-2 text-sm font-medium transition-colors hover:bg-black/5 disabled:opacity-50 dark:border-white/20 dark:hover:bg-white/10"
