    ...
    <>
      <div className="mb-5 flex flex-wrap items-center gap-2 rounded-2xl border border-black/5 bg-white p-3 shadow-sm dark:border-white/5 dark:bg-zinc-900 sm:flex-nowrap">
        <button
          ...
          className="min-w-0 flex-1 basis-full rounded-full bg-black/[0.05] px-4 py-2.5 text-left text-sm text-black/50 transition-colors hover:bg-black/[0.08] dark:bg-white/10 dark:text-white/50 dark:hover:bg-white/15 sm:basis-auto"
        >
                ...
                return (
                  <li key={d.title}>
                    <Link
                      href={d.href}
                      onClick={() => setOpen(false)}
                      className="flex items-center gap-4 rounded-2xl border border-black/5 bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-white/10 dark:bg-zinc-900"
                    >
                      <span
